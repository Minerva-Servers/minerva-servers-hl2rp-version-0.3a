...
if (SERVER) then
	...
	function PLUGIN:PlayerLoadedCharacter(client, curChar, prevChar)
		...
		if (curChar) then
			...
			for _, v in pairs(inv:GetItems()) do
				...
				elseif (v.noEquip and v:GetData("equip") != false and v.pacData) then
					client:AddPart(v.uniqueID, v)
				end
			end
		end
	...
	function PLUGIN:PlayerChangedTeam(client)
	...
	function PLUGIN:PlayerSwitchWeapon(client, oldWeapon, newWeapon)
		...
		elseif (oldItem and oldItem.isWeapon and oldItem.noEquip and oldItem:GetData("equip") != false and oldItem.pacData) then
			oldItem:WearPAC(client)
		end
