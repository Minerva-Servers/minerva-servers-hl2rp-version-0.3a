...
local buttonPadding = ScreenScale(8) * 0.5
...
function PANEL:Init()
    self:SetFont("ixMenuButtonFontSmall")
...
function PANEL:PaintBackground(width, height)
    local alpha = self.selected and 200 or self.currentBackgroundAlpha
