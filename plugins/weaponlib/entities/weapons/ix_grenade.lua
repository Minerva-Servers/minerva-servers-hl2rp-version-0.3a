...
local function TimedTick(ent, time)
    timer.Simple(time, function()
        ...
        ent:EmitSound("Weapon_Grenade.Tick")
    end)
end
...
function SWEP:ProjectileFire()
    ...
    if ( SERVER ) then
        ...
        explodeEnt:EmitSound("Weapon_Grenade.Explode")
