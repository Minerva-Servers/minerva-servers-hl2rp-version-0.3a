...
function PANEL:Init()
    ...
    for k, v in pairs(ix.item.list) do
        ...
        if not ( v.shopTerminalRequiredClass and LocalPlayer():GetTeamClass() == v.shopTerminalRequiredClass ) then
            continue
        end
        ...
        item.DoClick = function(this)
            ...
            itemDescription:SetFontInternal("ixBigFont")
