...
function PANEL:Init()
	...
	menuFile:AddOption("Load sequence", function()
		...
		browser:SetBaseFolder("minerva/eventmanager")
		browser:SetOpen(true)
		browser:SetCurrentFolder("minerva/eventmanager")
...
function PANEL:SetupPlayer(sequences)
	...
	for v,k in pairs(sequences) do
		...
		local play = vgui.Create("ixMenuButton", sequence)
		play:SetPos(500, 0)
		play:SetSize(150, 35)
		play:SetText("PLAY")
		...
		local stop = vgui.Create("ixMenuButton", sequence)
		stop:SetPos(350, 0)
		stop:SetSize(150, 35)
		stop:SetText("STOP")
